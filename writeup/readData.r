...
data = data %>% mutate(RegType = ifelse(ModelName %in% forSurp, "Surp", 
                                 ...
                                 ifelse(ModelName %in% forSurpDepL, "DL+Surp",
                                 ifelse(ModelName %in% forSurpWord, "SurpWord",
                                 ifelse(ModelName %in% forBackSurp, "BackSurp",
